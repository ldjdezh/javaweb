...
public class MobileForm {
	...
	private MobileClassify mobile_classify;
	...
	public MobileClassify getMobile_classify() {
		return mobile_classify;
	}

	public void setMobile_classify(MobileClassify mobile_classify) {
		this.mobile_classify = mobile_classify;
	}
